...
export const Categories: React.FC = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener("krashe-add-category", handler);
    return () => {
      window.removeEventListener("krashe-add-category", handler);
    };
  }, []);
  ...
  if (error) {
    return (
      <div style={{ padding: "80px 20px", textAlign: "center", color: "#ef4444" }}>
        ...
        <h3 style={{ fontSize: 16, fontWeight: 700, margin: 0 }}>Failed to Load Categories</h3>
